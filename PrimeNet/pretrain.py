...
parser.add_argument('--output_dir', type=str, required=True, help='Directory to save the pretrained model to')
...
def eval(args, model, eval_loader):
    ...
    with torch.no_grad():
        for train_batch in tqdm(eval_loader):
...
if __name__ == '__main__':
    # args.path = '/data/av38898/sdoh/data/pretrain/'
    ...
    for itr in tqdm(range(1, args.niters + 1)):
        ...
        if args.pretrain_tasks == 'full' or args.pretrain_tasks == 'cl' or args.pretrain_tasks == 'full2':
            if val_acc > best_acc:
                ...
                }, args.output_dir + str(experiment_id) +
                    '.h5')
        ...
        print('Iter: {}, train_cl_loss: {:.4f}, train_mse_loss: {:.4f}, train_acc: {:.4f}, dev_acc: {:.4f}, best_acc: {:.4f}\n'
